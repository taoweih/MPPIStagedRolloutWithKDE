...
class UPointMass(Task):
    ...
    def __init__(self) -> None:
        ...
        mj_model = mujoco.MjModel.from_xml_path(ROOT + "/models/u_point_mass/scene.xml")
        super().__init__(
            mj_model,
    ...
    def success_function(self, state: mjx.Data, control: jax.Array) -> jax.Array:
        ...
        cost = jnp.sqrt(jnp.sum(jnp.square(end_effector_pos - goal_pos),axis=0))
        return cost
    ...
    def terminal_cost(self, state: mjx.Data) -> jax.Array:
        ...
        cost = jnp.sum(jnp.abs(end_effector_pos - goal_pos),axis=0)
        return 100*cost
